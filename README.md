...
> Backend · Frontend · Aplicaciones web

---

## 🧠 Sobre mí

Soy desarrollador con experiencia en **desarrollo web full stack**, trabajando tanto en **backend** como en **frontend**. Me enfoco en construir aplicaciones claras, bien estructuradas y funcionales, aplicando buenas prácticas y mejorando constantemente.

Trabajo principalmente con **APIs**, **bases de datos** y aplicaciones web modernas.
